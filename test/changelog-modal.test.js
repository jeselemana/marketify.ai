...
test("script.js: changelog modal functions comply with Frontend XSS rules (Rule 4), provide email feedback, and wire event listeners", async () => {
  ...
  // Feedback button points to helmerworkspace@googlegroups.com
  assert.ok(changelogBlock.includes("helmerworkspace@googlegroups.com"), "Send Feedback button redirects to helmerworkspace@googlegroups.com");
